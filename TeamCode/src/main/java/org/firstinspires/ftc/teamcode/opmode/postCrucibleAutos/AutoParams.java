...
public class AutoParams {
    public static class Collect {
        public double firstNearMaxVel = 25, maxVel = 19;
        ...
        public double secondNearXRed = 13.25, secondFarXRed = 9, secondNearXBlue = 15, secondFarXBlue = 12;
        public double preThirdYRed = 32, preThirdYBlue = -35, postThirdYRed = 51, postThirdYBlue = -51;
        public double thirdNearXRed = 34, thirdFarXRed = 30, thirdNearXBlue = 37, thirdFarXBlue = 35.5;
    ...
    public static class Misc {
        ...
        public double gateNearX1Red = -3.5, gateNearX2Red = -0.5, gateNearYRed = 61,  gateNearX1Blue = -5, gateNearX2Blue = -1.5, gateNearYBlue = -64;
