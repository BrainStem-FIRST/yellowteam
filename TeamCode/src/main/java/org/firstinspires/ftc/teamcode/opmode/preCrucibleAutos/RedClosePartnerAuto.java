...
//        Action firstLineShots = autoPositions.redCollectAndShootFirstLine(true);
//        Action secondLineShots = autoPositions.redCollectAndShootSecondLine(true);
//        Action thirdLineShots = autoPositions.redCollectAndShootThirdLine(true);
