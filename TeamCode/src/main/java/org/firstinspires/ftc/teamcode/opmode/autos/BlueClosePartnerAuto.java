...
//        Action blueFirstLineShots = autoPositions.blueCollectAndShootFirstLine(true);
//        Action blueSecondLineShots = autoPositions.blueCollectAndShootSecondLine(true);
//        Action blueThirdLineShots = autoPositions.blueCollectAndShootThirdLine(true);
