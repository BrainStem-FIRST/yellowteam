...
public class RedFarPartnerAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action driveToShootingPose = autoPositions.redDriveFarShootingPose(startPose);
        Action thirdLineShots = autoPositions.redCollectAndShootThirdLine(false, false, false);
        Action secondLineShots = autoPositions.redCollectAndShootSecondLine(false, true, false);
        Action firstLineShots = autoPositions.redCollectAndShootFirstLine(true, true, false);
        Action humanPlayerShots = autoPositions.redCollectAndShootLoadingZone(false, false);
