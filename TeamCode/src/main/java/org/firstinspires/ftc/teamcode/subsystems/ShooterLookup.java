...
public class ShooterLookup {
    public static double[] dists =    {29.6, 34,   39,   44,   49,   53,   61,   67,   73.4, 80,   86,   95.69,98,   104,  109,  127, 128,  136,  138,  146.5, 154,  161};
    public static double[] vels =     {1250, 1260, 1250, 1280, 1280, 1310, 1370, 1430, 1490, 1530, 1580, 1636, 1650, 1700, 1720, 1870, 1870, 1930, 1930, 1990, 2060,  2090};
    public static double[] exitAngs = {1.25, 1.15, 1.1,  1,    1,    0.98, 0.95, 0.93, 0.87, 0.81, 0.75, 0.724,0.7,  0.7,  0.7,  0.62, 0.62, 0.62, 0.62, 0.62, 0.62, 0.62};
