...
public class ShooterLookup {
    ...
    public static double[] vels =     {1250, 1260, 1250, 1280, 1280, 1310, 1370, 1420, 1430, 1490, 1530, 1580, 1650,  1680, 1700, 1710, 1720, 1870, 1870, 1930, 1930, 1960, 1990, 2060,  2090};
