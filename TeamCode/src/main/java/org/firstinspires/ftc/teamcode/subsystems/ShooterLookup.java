...
public class ShooterLookup {
    ...
    public static double[] vels =     {1250, 1260, 1250, 1280, 1280, 1310, 1370, 1420, 1430, 1490, 1530, 1580, 1650,  1680, 1700, 1710, 1720, 1870, 1870, 1960, 1960, 1960, 1990, 2060,  2090};
    public static double[] exitAngs = {1.25, 1.15, 1.1,  1,    1,    0.98, 0.95, 0.94, 0.93, 0.87, 0.81, 0.75, 0.724, 0.7,  0.7, 0.7,  0.7,  0.62, 0.62, 0.62, 0.62,  0.62, 0.62, 0.62, 0.62};
